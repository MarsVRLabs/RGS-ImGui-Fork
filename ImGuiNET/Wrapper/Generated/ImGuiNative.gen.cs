...
namespace ImGuiNET
{
    public static unsafe partial class ImGuiNative
    {
        ...
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern void igErrorCheckEndFrameRecover(ImGuiErrorLogCallback logCallbackData, void* user_data);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern void igErrorCheckEndWindowRecover(ImGuiErrorLogCallback logCallbackData, void* user_data);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
