...
#if IMGUI_FEATURE_CUSTOM_ASSERT
            io.BackendPlatformUserData = Marshal.GetFunctionPointerForDelegate(_logAssert);
            Debug.Log("assigned imgui callback!");
            // io.BackendPlatformUserData<CustomAssertData>(new CustomAssertData
            // {
