...
namespace ImGuiNET.Unity
{
    ...
    sealed class ImGuiPlatformInputSystem : IImGuiPlatform
    {
        ...
        public unsafe bool Initialize(ImGuiIOPtr io)
        {
            ...
            string str = "Unity Input System" + char.MinValue;
            byte* buffer = (byte*)ASCIIEncoding.ASCII.GetBytes(str)[0];
            //io.BackendPlatformName = new NullTerminatedString(buffer);                    // setup backend info and capabilities
