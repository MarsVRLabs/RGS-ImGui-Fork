...
namespace ImGuiNET.Unity
{
    ...
    sealed class ImGuiPlatformInputManager : IImGuiPlatform
    {
        ...
        public bool Initialize(ImGuiIOPtr io)
        {
            ...
            //io.BackendPlatformName(Encoding.ASCII.GetBytes("Unity Input Manager"));                   // setup backend info and capabilities
            ...
            Debug.Log("assigning imgui callback...");
        ...
        public void PrepareFrame(ImGuiIOPtr io, Rect displayRect)
        {
            ...
            // Debug.Log(" asdf: " + Time.unscaledDeltaTime);
            if (Time.unscaledDeltaTime <= 0f)
            {
                io.DeltaTime = 0.01f;
                Debug.LogError("Unscaled Delta Time was 0! Setting to 0.01f so ImGui doesn't crash.");
            }
            else
            {
        ...
        {
            Debug.Log("Setting up ImGui Keyboard");
            _mainKeys = new int[] {
        ...
        static void UpdateMouse(ImGuiIOPtr io)
        {
            ...
            // Debug.Log(io.MousePos.x + " " + io.MousePos.y);
            // Debug.Log(io.MouseDown[0] + " " + io.MouseDown[1] + " " + io.MouseDown [2]);
        }
